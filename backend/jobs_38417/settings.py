"""
Django settings for jobs_38417 project.
...
WSGI_APPLICATION = 'jobs_38417.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jobs_38417 API",
    "DESCRIPTION": "API documentation for jobs_38417 App",
    "VERSION": "v1",
}
